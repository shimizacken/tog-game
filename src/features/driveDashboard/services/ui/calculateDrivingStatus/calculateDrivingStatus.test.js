...
describe("calculateDrivingStatus test suite", () => {
  ...
  describe("not driving at 0 speed", () => {
    it("should return not driving when ERROR and 0", () => {
      expect(
        calculateDrivingStatus(DrivingButtonStates.ERROR, 0)
      ).toMatchSnapshot();
    });

    it("should return not driving when TURNED_OFF and 0", () => {
      expect(
        calculateDrivingStatus(DrivingButtonStates.TURNED_OFF, 0)
      ).toMatchSnapshot();
    });

    it("should return not driving when DRIVE and 0", () => {
      expect(
        calculateDrivingStatus(DrivingButtonStates.DRIVE, 0)
      ).toMatchSnapshot();
    });
  });
  ...
  describe("not driving at more than 0 speed", () => {
    it("should return not driving when ERROR and 1", () => {
      ...
      expect(
        calculateDrivingStatus(DrivingButtonStates.ERROR, throttleSpeed)
      ).toMatchSnapshot();
    });
    ...
    it("should return not driving when TURNED_OFF and 50", () => {
      ...
      expect(
        calculateDrivingStatus(DrivingButtonStates.TURNED_OFF, throttleSpeed)
      ).toMatchSnapshot();
    });
    ...
    it("should return not driving when READY and 50", () => {
      ...
      expect(
        calculateDrivingStatus(DrivingButtonStates.READY, throttleSpeed)
      ).toMatchSnapshot();
    });
  });
  ...
  describe("driving", () => {
    it("should drive when DRIVE and more than 0", () => {
      ...
      expect(
        calculateDrivingStatus(DrivingButtonStates.DRIVE, throttleSpeed)
      ).toMatchSnapshot();
    });
  });
});
