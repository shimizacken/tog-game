...
describe("driveDashboard reducer test suite", () => {
  ...
  describe("SET_DRIVE_BUTTON_STATUS test suite", () => {
    it("should set DRIVE with initial state", () => {
      ...
      expect(
        driveDashboard(state, setDrivingButtonState(DrivingButtonStates.DRIVE))
      ).toMatchSnapshot();
    });
    ...
    it("should set ERROR with initial state", () => {
      ...
      expect(
        driveDashboard(state, setDrivingButtonState(DrivingButtonStates.ERROR))
      ).toMatchSnapshot();
    });
    ...
    it("should set TURNED_OFF with initial state", () => {
      ...
      expect(
        driveDashboard(
          state,
          setDrivingButtonState(DrivingButtonStates.TURNED_OFF)
        )
      ).toMatchSnapshot();
    });
    ...
    it("should set READY with none initial state", () => {
      ...
      expect(
        driveDashboard(state, setDrivingButtonState(DrivingButtonStates.READY))
      ).toMatchSnapshot();
    });
    ...
    it("should set SWITCHING with none initial state", () => {
      ...
      expect(
        driveDashboard(
          state,
          setDrivingButtonState(DrivingButtonStates.SWITCHING)
        )
      ).toMatchSnapshot();
    });
  });
